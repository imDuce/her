              ...
              <div className="Content block">
                <div id="Genesis" className="FirstLockup block-center-start">
                  <div className="block gap-3">
                    <h3 className="text-3xl pb-[20px]">Genesis</h3>
                ...
                <div id="Behold" className="SecondLockup block-center-start">
                  <div className="block gap-3">
                    <h3 className="text-3xl pb-[20px]">Behold !</h3>
                    <div className="subhead">
                ...
                >
                  <div className="block gap-3">
                    <h3 className="text-3xl pb-[20px]">Cutest Troublemaker</h3>
                    <div className="subhead">
                ...
                >
                  <div className="block gap-3">
                    <h3 className="text-3xl pb-[20px]">Luminescense</h3>
                    <div className="subhead">
                ...
                <div id="ARTISTRY" className="SeventhLockup block-center-start">
                  <div className="block gap-3">
                    <h3 className="text-3xl pb-[20px]">Artistry</h3>
                    <div className="subhead">
                ...
                <div id="GLOW" className="NinethLockup block-center-start">
                  <div className="block gap-3">
                    <h3 className="text-3xl pb-[20px]">One Irreplaceable Glow</h3>
                    <div className="subhead">
                ...
                <div id="Cynophile" className="TenthLockup block-center-start">
                  <div className="block gap-3">
                    <h3 className="text-3xl pb-[20px]">Cynophile</h3>
                    <div className="subhead">
                ...
                >
                  <div className="block gap-3">
                    <h3 className="text-3xl pb-[20px]">Wayfarer</h3>
                    <div className="subhead">
