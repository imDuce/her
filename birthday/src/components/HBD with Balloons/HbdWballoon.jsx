...
const FireworksCanvas = () => {
  ...
  useEffect(() => {
    ...
    const opts = {
      strings: ["Cosmic Queen turns 25!", "Stepping into her Silver Era ... ", "Happy", "Birthday,", "Sharvari"],
    ...
    <>
      <div className='firstComponent'>
        <div className="canvas-container relative">
          ...
          />
          {showCake && (<><div className="text-3xl text-black flex z-[100000] cakeKhaao absolute top-[20%] left-[30%]">Aapke like Grapes and Chocolate Cheesecake 😋</div> <Cake/> </>)}
