...
import "./shikayat.css";
import TextAnimationImproved from "../Utilities/TextAnimationImproved.jsx";
import TextAnim3 from "../Utilities/TextAnimation3.jsx";

// Constants for glitch characters
const GLITCH_CHARS = "`¡™£¢∞§¶•ªº–≠åß∂ƒ©˙∆˚¬…æ≈ç√∫˜µ≤≥÷/?░▒▓<>/".split("");

/**
 * A glitchy text reveal title component
 */
...
// Main container component for the 404 page
const Container = ({ children }) => {
  return <div className="container">{children}</div>;
};

// FourOhFour component - the main page
const FourOhFour = () => {
  useEffect(() => {
  ...
  return (
    <main className="app-shell">
      <Container>
        <a className="return-link message" href="/#" rel="noreferrer noopener">
          Return to happiness
        </a>
        <Logo className="bear-logo--tears" />
        {/* <GlitchyText className="four-oh-four__code code">Shikaayat</GlitchyText> */}
        <GlitchyText className="four-oh-four__code-message code-message">
          Shikaayatein
        </GlitchyText>
        <div className="absolute top-[30%] left-[40%] text-5xl gap-1 ">
          {/* <TextAnim3 input={"Pictures were not provided as and when asked, which led to delay in development as well as hindered the quality"} /> */}
          <TextAnim3/>
        </div>
      </Container>
    </main>
